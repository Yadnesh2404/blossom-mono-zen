...
export default function ServiceHero({
  ...
  return (
    <section className={`relative h-[60vh] sm:h-[70vh] md:h-[80vh] w-screen max-w-full overflow-hidden bg-foreground ${className}`} style={{ marginLeft: 'calc((100% - 100vw) / 2)' }}>
      <motion.div
        ...
        >
          <div className="absolute inset-0 flex items-center justify-center">
            <motion.div
              ...
              className="px-6 sm:px-8 md:px-12 lg:px-16 max-w-4xl w-full mx-auto"
            >
              <div className="text-center flex flex-col items-center">
                {title.startsWith('LUXURY') ? (
                  ...
                  <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[5rem] font-heading tracking-[0.05em] text-[#FDFBF7] mb-2 drop-shadow-md whitespace-nowrap">
                    {title}
                  </h1>
                )}
                ...
                <p className="text-base sm:text-lg md:text-xl font-light leading-relaxed drop-shadow-sm mb-6 max-w-xl text-[#e8e4db] mx-auto text-center">
                  {description}
                </p>
                ...
                <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 w-full max-w-3xl mx-auto">
